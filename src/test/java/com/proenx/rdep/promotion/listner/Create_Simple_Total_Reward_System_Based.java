...
public class Create_Simple_Total_Reward_System_Based extends TestBase {
	...
	sp.signin(ht)
	.MasterPromotion(ht)
	.create_Simple_Total_Reward_Promotion(ht)
	.Simple_Total_Reward_System_Based_Promotion_With_Custom_Store_All_Product(ht);
